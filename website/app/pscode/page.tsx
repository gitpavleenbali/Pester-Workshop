...
const modules = [
  ...
  { num: "03", name: "Mastering Parameters", file: "Azure-Parameter-Mastery.ps1", folder: "03_mastering_parameters", difficulty: "Intermediate", desc: "ValidateSet, Mandatory, parameter sets, binding in Azure scenarios", tags: ["ValidateSet", "Get-Command metadata"] },
  { num: "04", name: "PowerShell Classes", file: "Azure-Classes-Training.ps1", folder: "04_powershell_classes", difficulty: "Intermediate", desc: "OOP, constructors, methods, inheritance with Azure resource classes", tags: ["No mocking", "State transitions", "-TestCases"] },
  { num: "05", name: "Error Handling", file: "Azure-Error-Handling-Training.ps1", folder: "05_error_handling", difficulty: "Intermediate+", desc: "Try/catch, error recovery, input validation with Azure deploys", tags: ["Should -Throw '*pattern*'", "Mock override"] },
  { num: "06", name: "Debugging", file: "Debug-Demo.ps1", folder: "06_debugging", difficulty: "Intermediate+", desc: "Data processing pipeline, breakpoints, tracing, pure functions", tags: ["Pure functions", "-TestCases", "Should -Match"] },
  ...
  { num: "08", name: "Runspaces", file: "Azure-Runspaces-Masterclass.ps1", folder: "08_runspaces", difficulty: "Advanced", desc: "Parallel execution, thread safety, concurrent Azure operations", tags: ["Pure functions", "Edge cases", "@() wrapping"] },
  { num: "09", name: "Capstone", file: "Azure-Cost-Monitor.ps1", folder: "09_final_solution_apply_learnings", difficulty: "Expert", desc: "Real-world cost monitoring integrating all 8 prior modules", tags: ["Boundary testing", "$script: scope", "Mock Send-MailMessage"] },
];
